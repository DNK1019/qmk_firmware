...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_LAYER1] = LAYOUT_65_ansi_blocker( /* FN keys */
		...
		[_LAYER2] = LAYOUT_65_ansi_blocker( /* Special */
		    ...
		    KC_LSFT,       KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TILD,  KC_MPLY,          KC_VOLU,  KC_MUTE,
